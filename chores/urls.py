...
urlpatterns = [
    ...
    url(r'^(?P<chorelist_id>[0-9]+)/delete/$', views.deletechorelist, name='deletechorelist'),
    ...
    url(r'^(?P<chorelist_id>[0-9]+)/chores/(?P<chore_id>[0-9]+)/delete/$', views.deletechore, name='deletechore'),
]